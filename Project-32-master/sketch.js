...
function draw() {
  ...
  textSize(20);
  fill(138, 0, 188);
  text("Let's see if you the force is strong with you, boi",50,480)
  text("Press Space to get another cellmonger to defeat the 'ORYONIX'",50,425);
  text("Hold and drag mouse to use cell transbase",50,452);
